...
export default function Services() {
  ...
  const services = [
    { icon: <Lightbulb size={28} />, title: t('services.1.title'), desc: t('services.1.desc') },
    { icon: <LayoutTemplate size={28} />, title: t('services.2.title'), desc: t('services.2.desc') },
    { icon: <Bot size={28} />, title: t('services.3.title'), desc: t('services.3.desc') },
    { icon: <Workflow size={28} />, title: t('services.4.title'), desc: t('services.4.desc') },
    { icon: <Smartphone size={28} />, title: t('services.5.title'), desc: t('services.5.desc') },
    { icon: <Globe size={28} />, title: t('services.6.title'), desc: t('services.6.desc') },
  ]
