...
const PhoneMockup = ({ className, children }: { className?: string; children: React.ReactNode }) => (
  <div
    className={`relative bg-[#111111] border-[8px] border-[#2a2a2a] rounded-[3rem] shadow-[0_0_80px_rgba(16,185,129,0.25)] overflow-hidden ${className}`}
  >
    ...
    <div className="relative z-10 h-full w-full p-6 pt-16 flex flex-col gap-4">{children}</div>
  </div>
)
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-bg">
      {/* Immersive Falling iPhones Background */}
