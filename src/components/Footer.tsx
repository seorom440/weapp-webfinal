      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-ink-muted">
              <li><a href="/#services" className="hover:text-ink transition-colors">{t('footer.services.1')}</a></li>
              <li><a href="/#services" className="hover:text-ink transition-colors">{t('footer.services.2')}</a></li>
              <li><a href="/#services" className="hover:text-ink transition-colors">{t('footer.services.3')}</a></li>
              <li><a href="/#services" className="hover:text-ink transition-colors">{t('footer.services.4')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-ink-muted">
              <li><a href="/#about" className="hover:text-ink transition-colors">{t('footer.company.1')}</a></li>
              <li><a href="/#projects" className="hover:text-ink transition-colors">{t('footer.company.2')}</a></li>
              <li><a href="/#contact" className="hover:text-ink transition-colors">{t('footer.company.3')}</a></li>
              <li><a href="/" className="hover:text-ink transition-colors">{t('footer.company.4')}</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-ink-muted">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#" className="hover:text-ink transition-colors">{t('footer.legal')}</a>
            <a href="#" className="hover:text-ink transition-colors">{t('footer.gdpr')}</a>
          </div>
        </div>
      </div>
    </footer>
